...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#2a03afbd#;
   ...
   u00178 : constant Version_32 := 16#d6cfcab7#;
   pragma Export (C, u00178, "dom__core__attrsB");
   u00179 : constant Version_32 := 16#4f3aef62#;
   pragma Export (C, u00179, "dom__core__attrsS");
   u00180 : constant Version_32 := 16#5853eea9#;
   pragma Export (C, u00180, "dom__core__nodesB");
   u00181 : constant Version_32 := 16#d698d5da#;
   pragma Export (C, u00181, "dom__core__nodesS");
   u00182 : constant Version_32 := 16#eeeb4b65#;
   pragma Export (C, u00182, "ada__text_io__text_streamsB");
   u00183 : constant Version_32 := 16#4986ba89#;
   pragma Export (C, u00183, "ada__text_io__text_streamsS");
   u00184 : constant Version_32 := 16#a1d6147d#;
   pragma Export (C, u00184, "system__compare_array_unsigned_8B");
   u00185 : constant Version_32 := 16#0bd9e790#;
   pragma Export (C, u00185, "system__compare_array_unsigned_8S");
   u00186 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00186, "system__address_operationsB");
   u00187 : constant Version_32 := 16#b1d6282e#;
   pragma Export (C, u00187, "system__address_operationsS");
   u00188 : constant Version_32 := 16#f819c43c#;
   ...
   u00190 : constant Version_32 := 16#a8c2f76e#;
   pragma Export (C, u00190, "unicode__encodingsB");
   u00191 : constant Version_32 := 16#0dd3cf4a#;
   pragma Export (C, u00191, "unicode__encodingsS");
   u00192 : constant Version_32 := 16#42b36dfe#;
   pragma Export (C, u00192, "ada__strings__unboundedB");
   u00193 : constant Version_32 := 16#da258d18#;
   pragma Export (C, u00193, "ada__strings__unboundedS");
   u00194 : constant Version_32 := 16#36068beb#;
   pragma Export (C, u00194, "ada__strings__searchB");
   u00195 : constant Version_32 := 16#73987e07#;
   ...
   u00197 : constant Version_32 := 16#1686bb90#;
   pragma Export (C, u00197, "system__atomic_countersS");
   u00198 : constant Version_32 := 16#2cc3eaf2#;
   pragma Export (C, u00198, "unicode__ccs__iso_8859_1B");
   u00199 : constant Version_32 := 16#8e38bcbd#;
   pragma Export (C, u00199, "unicode__ccs__iso_8859_1S");
   u00200 : constant Version_32 := 16#5d55fc19#;
   pragma Export (C, u00200, "unicode__ccs__iso_8859_15B");
   u00201 : constant Version_32 := 16#92feba06#;
   pragma Export (C, u00201, "unicode__ccs__iso_8859_15S");
   u00202 : constant Version_32 := 16#f736a935#;
   pragma Export (C, u00202, "unicode__names__currency_symbolsS");
   u00203 : constant Version_32 := 16#78ee47b1#;
   pragma Export (C, u00203, "unicode__names__latin_1_supplementS");
   u00204 : constant Version_32 := 16#5cfe3178#;
   pragma Export (C, u00204, "unicode__names__latin_extended_aS");
   u00205 : constant Version_32 := 16#1c4bceb3#;
   pragma Export (C, u00205, "unicode__ccs__iso_8859_2B");
   u00206 : constant Version_32 := 16#349a01be#;
   pragma Export (C, u00206, "unicode__ccs__iso_8859_2S");
   u00207 : constant Version_32 := 16#c90d6e9f#;
   pragma Export (C, u00207, "unicode__names__spacing_modifier_lettersS");
   u00208 : constant Version_32 := 16#c7ca5c74#;
   pragma Export (C, u00208, "unicode__ccs__iso_8859_3B");
   u00209 : constant Version_32 := 16#487a726a#;
   pragma Export (C, u00209, "unicode__ccs__iso_8859_3S");
   u00210 : constant Version_32 := 16#480189f0#;
   pragma Export (C, u00210, "unicode__ccs__iso_8859_4B");
   u00211 : constant Version_32 := 16#ad57c2bd#;
   pragma Export (C, u00211, "unicode__ccs__iso_8859_4S");
   u00212 : constant Version_32 := 16#4b4b6a37#;
   pragma Export (C, u00212, "unicode__ccs__windows_1251B");
   u00213 : constant Version_32 := 16#ba76c289#;
   pragma Export (C, u00213, "unicode__ccs__windows_1251S");
   u00214 : constant Version_32 := 16#f6cba099#;
   pragma Export (C, u00214, "unicode__names__cyrillicS");
   u00215 : constant Version_32 := 16#4b7938ca#;
   pragma Export (C, u00215, "unicode__names__general_punctuationS");
   u00216 : constant Version_32 := 16#c0b9df8b#;
   pragma Export (C, u00216, "unicode__names__letterlike_symbolsS");
   u00217 : constant Version_32 := 16#706123e1#;
   pragma Export (C, u00217, "unicode__ccs__windows_1252B");
   u00218 : constant Version_32 := 16#7cee5e39#;
   pragma Export (C, u00218, "unicode__ccs__windows_1252S");
   u00219 : constant Version_32 := 16#958389e0#;
   pragma Export (C, u00219, "unicode__names__latin_extended_bS");
   u00220 : constant Version_32 := 16#ba342546#;
   pragma Export (C, u00220, "unicode__ces__basic_8bitB");
   u00221 : constant Version_32 := 16#4161d344#;
   pragma Export (C, u00221, "unicode__ces__basic_8bitS");
   u00222 : constant Version_32 := 16#ad1d2052#;
   pragma Export (C, u00222, "unicode__ces__utf16B");
   u00223 : constant Version_32 := 16#76c334e3#;
   pragma Export (C, u00223, "unicode__ces__utf16S");
   u00224 : constant Version_32 := 16#f0a7720c#;
   pragma Export (C, u00224, "dom__core__documentsB");
   u00225 : constant Version_32 := 16#9a0c02e1#;
   pragma Export (C, u00225, "dom__core__documentsS");
   u00226 : constant Version_32 := 16#18cb740a#;
   pragma Export (C, u00226, "dom__core__elementsB");
   u00227 : constant Version_32 := 16#92281457#;
   pragma Export (C, u00227, "dom__core__elementsS");
   u00228 : constant Version_32 := 16#f24025b6#;
   pragma Export (C, u00228, "dom__readersB");
   u00229 : constant Version_32 := 16#b93c7452#;
   pragma Export (C, u00229, "dom__readersS");
   u00230 : constant Version_32 := 16#9ff1faba#;
   pragma Export (C, u00230, "dom__core__character_datasB");
   u00231 : constant Version_32 := 16#06ea1232#;
   pragma Export (C, u00231, "dom__core__character_datasS");
   u00232 : constant Version_32 := 16#21fdcff6#;
   pragma Export (C, u00232, "sax__attributesB");
   u00233 : constant Version_32 := 16#5ab7981b#;
   pragma Export (C, u00233, "sax__attributesS");
   u00234 : constant Version_32 := 16#0de7ae30#;
   pragma Export (C, u00234, "ada__strings__fixedB");
   u00235 : constant Version_32 := 16#64881af1#;
   pragma Export (C, u00235, "ada__strings__fixedS");
   u00236 : constant Version_32 := 16#3d8854f0#;
   pragma Export (C, u00236, "sax__modelsB");
   u00237 : constant Version_32 := 16#3350c648#;
   pragma Export (C, u00237, "sax__modelsS");
   u00238 : constant Version_32 := 16#55d60400#;
   pragma Export (C, u00238, "sax__exceptionsB");
   u00239 : constant Version_32 := 16#1bf9ab35#;
   pragma Export (C, u00239, "sax__exceptionsS");
   u00240 : constant Version_32 := 16#a7f1b3a1#;
   pragma Export (C, u00240, "sax__locatorsB");
   u00241 : constant Version_32 := 16#069b7760#;
   pragma Export (C, u00241, "sax__locatorsS");
   u00242 : constant Version_32 := 16#014c2eaa#;
   pragma Export (C, u00242, "gnat__directory_operationsB");
   u00243 : constant Version_32 := 16#d9c6d728#;
   pragma Export (C, u00243, "gnat__directory_operationsS");
   u00244 : constant Version_32 := 16#2b995a0d#;
   pragma Export (C, u00244, "gnat__os_libS");
   u00245 : constant Version_32 := 16#f6efe8c4#;
   pragma Export (C, u00245, "sax__readersB");
   u00246 : constant Version_32 := 16#20801fd7#;
   pragma Export (C, u00246, "sax__readersS");
   u00247 : constant Version_32 := 16#772f9c73#;
   pragma Export (C, u00247, "input_sourcesB");
   u00248 : constant Version_32 := 16#ef327363#;
   pragma Export (C, u00248, "input_sourcesS");
   u00249 : constant Version_32 := 16#5556565c#;
   pragma Export (C, u00249, "input_sources__fileB");
   u00250 : constant Version_32 := 16#e1007772#;
   pragma Export (C, u00250, "input_sources__fileS");
   u00251 : constant Version_32 := 16#956e676b#;
   pragma Export (C, u00251, "input_sources__stringsB");
   u00252 : constant Version_32 := 16#d2561cff#;
   pragma Export (C, u00252, "input_sources__stringsS");
